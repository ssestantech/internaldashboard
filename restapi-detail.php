...
<header class="header">
    <div class="container-fluid d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="title">Rest API Details</div>
                ...
                <div class="product-detail-head">
                    <div class="row">
                        <div class="col-md-6 col-12 d-flex flex-wrap product-main">
                            <div class="short-name">A1</div>
                            <div class="product-name">
                                <div class="heading"><span>Polycarbonate Polarized Blue Glass</span> <div class="btn-status2 closed-1">Closed</div></div>
