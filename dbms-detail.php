...
<header class="header">
    <div class="container-fluid d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="title">DBMS Details</div>
...
<div class="main-container">
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between sub-header">
            <div class="heading">DBMS Details</div>
        </div>
        <div class="white-box-wraper mb-4">
            <div class="box-header">
                <div class="heading">Pipelines/Dockers Details</div>
            </div>
            <div class="product-detail">
                <div class="product-detail-head">
                    <div class="row">
                        <div class="col-md-6 col-12 d-flex flex-wrap product-main">
                            <div class="image"><img src="images/database.png" alt="Database"></div>
                            <div class="product-name">
                                <div class="heading">Database 01</div>
                                <div class="button-wrapper">
                                    <div class="d-flex flex-wrap align-items-center field">
                                        <label>CPU</label>
                                        <div class="btn-database ml-auto btn-database-red">2</div>
                                    </div>
                                    <div class="d-flex flex-wrap align-items-center field">
                                        <label>Memory</label>
                                        <div class="btn-database ml-auto btn-database-orange">2</div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-12">
                            <div class="product-info">
                                <div class="heading">At vero eos et accusamus et iusto odio</div>
                                <p>Et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.</p>
                            </div>
                            <div class="product-info-table">
                                <ul>
                                    <li class="start-date">
                        ...
                        <div class="col-md-7 col-12">
                            <div class="image"><img src="images/graph-dbms-2.jpg" alt="Overall Performance"></div>
                        </div>
                    </div>
                </div>
            </div>
