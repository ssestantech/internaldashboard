...
<header class="header">
    <div class="container-fluid d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="title">Model Versions</div>
...
<div class="main-container">
    <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between sub-header">
            <div class="heading">Model Versions</div>
        ...
        <div class="grid-view model-versions" id="grid-view">
            <ul class="d-flex flex-wrap">
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #25C2E3;">M1</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                    </div>
                    <div class="bottom">
                        <table>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #9932E7;">M2</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #FAAE42;">M3</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #25C2E3;">M4</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #9932E7;">M5</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #FAAE42;">M6</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #25C2E3;">M7</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #9932E7;">M8</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #FAAE42;">M9</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #25C2E3;">M10</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #9932E7;">M11</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
                ...
                <li>
                    <input type="checkbox" name="" id="">
                    <div class="d-flex flex-wrap align-items-center top">
                        <div class="short-name" style="background-color: #FAAE42;">M12</div>
                        <div class="desc">
                            <div class="full-name">Dignissimos Jucimus</div>
                            <div class="sub-heading">α × β = (c / a)</div>
                        </div>
